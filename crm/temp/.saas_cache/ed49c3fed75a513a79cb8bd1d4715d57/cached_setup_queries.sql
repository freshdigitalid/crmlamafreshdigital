CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}activity_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994staffid` (`staffid`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}clients` (
  ...
  PRIMARY KEY (`userid`),
  KEY `demo1762568994country` (`country`),
  KEY `demo1762568994leadid` (`leadid`),
  KEY `demo1762568994company` (`company`),
  KEY `demo1762568994active` (`active`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}consents` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994purpose_id` (`purpose_id`),
  KEY `demo1762568994contact_id` (`contact_id`),
  KEY `demo1762568994lead_id` (`lead_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}contacts` (
  ...
  `is_opted_out` tinyint(1) DEFAULT 0,
  `opted_out_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994userid` (`userid`),
  KEY `demo1762568994firstname` (`firstname`),
  KEY `demo1762568994lastname` (`lastname`),
  KEY `demo1762568994email` (`email`),
  KEY `demo1762568994is_primary` (`is_primary`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}contracts` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994client` (`client`),
  KEY `demo1762568994contract_type` (`contract_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}creditnotes` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994currency` (`currency`),
  KEY `demo1762568994clientid` (`clientid`),
  KEY `demo1762568994project_id` (`project_id`),
  KEY `demo1762568994formatted_number` (`formatted_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}customer_admins` (
  ...
  KEY `demo1762568994customer_id` (`customer_id`),
  KEY `demo1762568994staff_id` (`staff_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}customer_groups` (
  ...
  `customer_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994groupid` (`groupid`),
  KEY `demo1762568994customer_id` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}customfieldsvalues` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994relid` (`relid`),
  KEY `demo1762568994fieldto` (`fieldto`),
  KEY `demo1762568994fieldid` (`fieldid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}dismissed_announcements` (
  ...
  KEY `demo1762568994announcementid` (`announcementid`),
  KEY `demo1762568994staff` (`staff`),
  KEY `demo1762568994userid` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=3187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}estimates` (
  ...
  KEY `demo1762568994currency` (`currency`),
  KEY `demo1762568994project_id` (`project_id`),
  KEY `demo1762568994sale_agent` (`sale_agent`),
  KEY `demo1762568994status` (`status`),
  KEY `demo1762568994formatted_number` (`formatted_number`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}expenses` (
  ...
  KEY `demo1762568994clientid` (`clientid`),
  KEY `demo1762568994project_id` (`project_id`),
  KEY `demo1762568994category` (`category`),
  KEY `demo1762568994currency` (`currency`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}files` (
  ...
  `dateadded` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994rel_id` (`rel_id`),
  KEY `demo1762568994rel_type` (`rel_type`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}filter_defaults` (
  ...
  KEY `demo1762568994filter_id` (`filter_id`),
  KEY `demo1762568994staff_id` (`staff_id`),
  CONSTRAINT `demo1762568994{TENANT_SLUG_PLACEHOLDER}filter_defaults_ibfk_1` FOREIGN KEY (`filter_id`) REFERENCES `tblfilters` (`id`) ON DELETE CASCADE,
  CONSTRAINT `demo1762568994{TENANT_SLUG_PLACEHOLDER}filter_defaults_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `tblstaff` (`staffid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}invoicepaymentrecords` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994invoiceid` (`invoiceid`),
  KEY `demo1762568994paymentmethod` (`paymentmethod`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}itemable` (
  ...
  KEY `demo1762568994rel_id` (`rel_id`),
  KEY `demo1762568994rel_type` (`rel_type`),
  KEY `demo1762568994qty` (`qty`),
  KEY `demo1762568994rate` (`rate`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}items` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994tax` (`tax`),
  KEY `demo1762568994tax2` (`tax2`),
  KEY `demo1762568994group_id` (`group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}item_tax` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994itemid` (`itemid`),
  KEY `demo1762568994rel_id` (`rel_id`)
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}leads` (
  ...
  KEY `demo1762568994company` (`company`),
  KEY `demo1762568994email` (`email`),
  KEY `demo1762568994assigned` (`assigned`),
  KEY `demo1762568994status` (`status`),
  KEY `demo1762568994source` (`source`),
  KEY `demo1762568994lastcontact` (`lastcontact`),
  KEY `demo1762568994dateadded` (`dateadded`),
  KEY `demo1762568994leadorder` (`leadorder`),
  KEY `demo1762568994from_form_id` (`from_form_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}sessions` (
  ...
  `data` blob NOT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994ci_sessions_timestamp` (`timestamp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}staff` (
  ...
  `flutex_api_key` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}subscriptions` (
  ...
  KEY `demo1762568994clientid` (`clientid`),
  KEY `demo1762568994currency` (`currency`),
  KEY `demo1762568994tax_id` (`tax_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}taggables` (
  ...
  KEY `demo1762568994rel_id` (`rel_id`),
  KEY `demo1762568994rel_type` (`rel_type`),
  KEY `demo1762568994tag_id` (`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}tasks` (
  ...
  KEY `demo1762568994rel_id` (`rel_id`),
  KEY `demo1762568994rel_type` (`rel_type`),
  KEY `demo1762568994milestone` (`milestone`),
  KEY `demo1762568994kanban_order` (`kanban_order`),
  KEY `demo1762568994status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}taskstimers` (
  ...
  `note` mediumtext DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994task_id` (`task_id`),
  KEY `demo1762568994staff_id` (`staff_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}task_assigned` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994taskid` (`taskid`),
  KEY `demo1762568994staffid` (`staffid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}task_comments` (
  ...
  `dateadded` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1762568994file_id` (`file_id`),
  KEY `demo1762568994taskid` (`taskid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}tickets` (
  ...
  KEY `demo1762568994service` (`service`),
  KEY `demo1762568994department` (`department`),
  KEY `demo1762568994status` (`status`),
  KEY `demo1762568994userid` (`userid`),
  KEY `demo1762568994priority` (`priority`),
  KEY `demo1762568994project_id` (`project_id`),
  KEY `demo1762568994contactid` (`contactid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `{TENANT_SLUG_PLACEHOLDER}twocheckout_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `demo1762568994invoice_id` (`invoice_id`),
  CONSTRAINT `demo1762568994{TENANT_SLUG_PLACEHOLDER}twocheckout_log_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `tblinvoices` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
