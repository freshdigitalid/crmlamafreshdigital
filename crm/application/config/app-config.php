...
*
*/
define('APP_BASE_URL_DEFAULT', 'https://crm.freshdigital.id/');
...
*/
define('APP_ENC_KEY', '45cc383e179cc72fd1b726de13a5c978');
 ...
 */
define('APP_DB_USERNAME_DEFAULT', 'u822054845_Freshdigital');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD_DEFAULT', 'Fdinata7890@');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME_DEFAULT', 'u822054845_crmfdigital');
