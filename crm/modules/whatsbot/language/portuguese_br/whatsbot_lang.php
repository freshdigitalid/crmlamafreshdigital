...
$lang['access_token_description'] = 'Seu Token de Acesso de Usuário após se inscrever em uma conta no Facebook Developers Portal';
$lang['whatsapp_business_account_id'] = 'ID da Conta do WhatsApp Business';
...
$lang['create_template_base_bot'] = 'Criar bot base de template';
$lang['create_message_bot'] = 'Criar bot de mensagem';
$lang['type'] = 'Tipo';
$lang['message_bot'] = 'Bot de Mensagem';
$lang['new_template_bot'] = 'Novo Bot de Template';
$lang['new_message_bot'] = 'Novo Bot de Mensagem';
$lang['bot_name'] = 'Nome do Bot';
$lang['reply_text'] = 'Texto da Resposta <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Texto que será enviado para o lead ou contato. Você também pode usar {companyname}, {crm_url} ou qualquer outro campo de mesclagem personalizado do lead ou contato, ou usar o sinal \'@\' para encontrar campos de mesclagem disponíveis" data-placement="bottom"></i> <span class="text-muted">(Número máximo de caracteres permitido deve ser 1024)</span>';
$lang['reply_type'] = 'Tipo de Resposta';
$lang['trigger'] = 'Gatilho';
$lang['header'] = 'Cabeçalho';
$lang['footer_bot'] = 'Rodapé <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 60" data-placement="bottom"></i>';
$lang['bot_with_reply_buttons'] = 'Opção 1: Bot com botões de resposta';
$lang['bot_with_button_link'] = 'Opção 2: Bot com link de botão - URL do CTA';
$lang['button1'] = 'Botão1 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 20" data-placement="bottom"></i>';
$lang['button1_id'] = 'ID do Botão1 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 256" data-placement="bottom"></i>';
$lang['button2'] = 'Botão2 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 20" data-placement="bottom"></i>';
$lang['button2_id'] = 'ID do Botão2 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 256" data-placement="bottom"></i>';
$lang['button3'] = 'Botão3 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 20" data-placement="bottom"></i>';
$lang['button3_id'] = 'ID do Botão3 <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 256" data-placement="bottom"></i>';
$lang['button_name'] = 'Nome do Botão <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Número máximo de caracteres permitido deve ser 20" data-placement="bottom"></i>';
...
$lang['template_data_loaded'] = 'Templates carregados com sucesso';
...
$lang['scheduled_send_time'] = '<i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="Por cliente, baseado no fuso horário de contato" data-placement="left"></i>Hora de Envio Programada';
$lang['scheduled_time_description'] = 'Por cliente, baseado no fuso horário de contato';
...
$lang['match_with_selected_field'] = 'Combinar com um campo selecionado';
...
$lang['of_your'] = 'de seus ';
$lang['contacts'] = 'Contatos';
$lang['select_all_leads'] = 'Selecionar todos os Leads';
$lang['select_all_note_leads'] = 'Se você selecionar isso, todos os futuros leads estarão incluídos nesta campanha.';
$lang['select_all_note_contacts'] = 'Se você selecionar isso, todos os futuros contatos estarão incluídos nesta campanha.';
...
// Template bot
$lang['create_new_template_bot'] = 'Criar novo modelo de bot';
$lang['template_bot'] = 'Bot de Modelo';
$lang['variables'] = 'Variáveis';
$lang['preview'] = 'Pré-visualização';
$lang['template'] = 'Modelo';
$lang['bot_content_1'] = 'Esta mensagem será enviada ao contato assim que a regra de disparo for atendida na mensagem enviada pelo contato.';
...
$lang['template_bot_create_successfully'] = 'Bot de modelo criado com sucesso';
$lang['template_bot_update_successfully'] = 'Bot de modelo atualizado com sucesso';
$lang['text_bot'] = 'Bot de Texto';
$lang['option_2_bot_with_link'] = 'Opção 2: Bot com link de botão - Chamada para Ação (CTA) URL';
...
$lang['webhooks_label'] = 'Dados recebidos do WhatsApp serão reenviados para';
$lang['webhooks'] = 'WebHooks';
$lang['enable_webhooks'] = 'Ativar Reenvio de WebHooks';
$lang['chat'] = 'Chat';
$lang['black_listed_phone_numbers'] = 'Números de telefone na lista negra';
...
$lang['activity_log'] = 'Registro de Atividades';
...
$lang['allowed_file_types'] = 'Tipos de arquivos permitidos: ';
...
$lang['chat_media_info'] = 'Mais informações sobre Tipos de Conteúdo Suportados & Tamanho de Mídia Pós-Processamento';
$lang['help'] = 'Ajuda';
// v1.1.0
$lang['clone'] = 'Clonar';
...
$lang['replay_message'] = 'Você não pode enviar mensagem após 24 horas.';
$lang['support_agent_note'] = '<strong>Nota: </strong>Quando você ativa a funcionalidade de agente de suporte, o responsável pelo lead será automaticamente atribuído ao chat. Os administradores também podem atribuir um novo agente na página do chat.';
...
$lang['default_message_note'] = '<strong>Nota: </strong>Ativar esta opção aumentará a carga do seu webhook. Para mais informações, visite este <a href="https://docs.corbitaltech.dev/products/whatsbot/index.html" target="_blank">link</a>.';

$lang['whatsbot_connect_account'] = 'Conectar Conta Whatsbot';
$lang['whatsbot_message_bot'] = 'Bot de Mensagens Whatsbot';
$lang['whatsbot_template_bot'] = 'Bot de Template Whatsbot';
$lang['whatsbot_template'] = 'Template Whatsbot';
$lang['whatsbot_campaigns'] = 'Campanhas Whatsbot';
$lang['whatsbot_chat'] = 'Chat Whatsbot';
$lang['whatsbot_log_activity'] = 'Registro de Atividades Whatsbot';
$lang['message_templates_not_exists_note'] = 'Permissão de template meta ausente. Por favor, habilite-a na sua conta Meta';

// v1.2.0
$lang['ai_prompt'] = 'Prompt de IA';
$lang['ai_prompt_note'] = 'Para prompts de IA, por favor, insira uma mensagem para ativar a funcionalidade ou use os prompts de IA se já estiverem ativados';
$lang['emojis'] = 'Emojis';
...
$lang['chat_text_limit_note'] = 'Para otimizar os custos operacionais, considere limitar a contagem de palavras das respostas do chat da OpenAI';
...
$lang['attach_image_video_docs'] = 'Anexar Imagens, Vídeos e Documentos';
...
$lang['csv_uploaded_successfully'] = 'Arquivo CSV carregado com sucesso';
...
$lang['out_of_the'] = 'Fora do';
$lang['records_in_your_csv_file'] = 'registros no seu arquivo CSV,';
$lang['valid_the_campaign_can_be_sent'] = 'registros são válidos.<br /> A campanha pode ser enviada com sucesso para esses';
$lang['users'] = 'usuários';
$lang['campaigns_from_csv_file'] = 'Campanhas do Arquivo CSV';
$lang['download_sample'] = 'Baixar Amostra';
$lang['csv_rule_1'] = '1. <b>Requisitos da Coluna de Número de Telefone:</b> Seu arquivo CSV deve incluir uma coluna chamada "Phoneno." Cada registro nesta coluna deve conter um número de contato válido, corretamente formatado com o código do país, incluindo o sinal "+" . <br /><br />';
$lang['csv_rule_2'] = '2. <b>Formato e Codificação CSV:</b> Seus dados CSV devem seguir o formato especificado. A primeira linha do seu arquivo CSV deve conter os cabeçalhos das colunas, conforme mostrado na tabela de exemplo. Certifique-se de que seu arquivo esteja codificado em UTF-8 para evitar problemas de codificação.';
$lang['please_upload_valid_csv_file'] = 'Por favor, faça o upload de um arquivo CSV válido';
...
$lang['phoneno'] = 'Número de Telefone';
$lang['email'] = 'Email';
$lang['country'] = 'País';
$lang['download_sample_and_read_rules'] = 'Baixar Arquivo de Amostra e Ler Regras';
$lang['please_wait_your_request_in_process'] = 'Por favor, aguarde, seu pedido está sendo processado.';
$lang['whatsbot_bulk_campaign'] = 'Campanhas em Massa Whatsbot';
$lang['csv_campaign'] = 'Campanha CSV';

// Respostas Prontas
$lang['canned_reply'] = 'Resposta Pronta';
$lang['canned_reply_menu'] = 'Resposta Pronta';
$lang['create_canned_reply'] = 'Criar Resposta Pronta';
$lang['title'] = 'Título';
$lang['desc'] = 'Descrição';
$lang['public'] = 'Público';
$lang['action'] = 'Ação';
$lang['delete_successfully'] = 'Resposta deletada.';
$lang['cannot_delete'] = 'Resposta não pode ser deletada.';
$lang['whatsbot_canned_reply'] = 'Resposta Pronta Whatsbot';
$lang['reply'] = 'Resposta';
...
$lang['whatsbot_ai_prompts'] = 'Prompts de IA Whatsbot';

// novo chat
$lang['replying_to'] = 'Respondendo a:';
$lang['download_document'] = 'Baixar Documento';
$lang['custom_prompt'] = 'Prompt Personalizado';
$lang['canned_replies'] = 'Respostas Prontas';
$lang['use_@_to_add_merge_fields'] = 'Use \'@\' para adicionar campos mesclados';
...
$lang['you_can_not_upload_file_type'] = 'Você não pode enviar o tipo de arquivo <b> %s </b>';
$lang['whatsbot_bot_flow'] = 'Fluxo do Bot Whatsbot';

// v1.3.2
$lang['auto_clear_chat_history'] = 'Limpar Histórico de Chat Automaticamente';
$lang['enable_auto_clear_chat_history'] = 'Ativar Limpeza Automática do Histórico de Chat';
$lang['auto_clear_time'] = 'Tempo para Limpar o Histórico';
$lang['clear_chat_history_note'] = '<strong>Nota: </strong> Se você ativar a funcionalidade de limpeza automática do histórico de chat, ele será automaticamente limpo com base no número de dias que você especificar, sempre que a tarefa programada for executada.';
$lang['source'] = 'Fonte';
$lang['groups'] = 'Grupos';
