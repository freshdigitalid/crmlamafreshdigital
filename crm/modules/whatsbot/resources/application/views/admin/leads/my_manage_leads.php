                    ...
                    <div class="tw-flex tw-items-center tw-justify-between tw-space-x-2 rtl:tw-space-x-reverse">
                        <div class="tw-flex tw-items-center tw-space-x-1 rtl:tw-space-x-reverse">
                            ...
                            <?php if (is_admin() || get_option('allow_non_admin_members_to_import_leads') == '1') { ?>
                                ...
                                <a href="javascript:void(0)" id="initiate_chat_modal_btn" data-id="initiate_chat_modal" data-name="leads" class=""
                                    data-toggle="tooltip"><button class="hidden-xs btn btn-default"><i class="fa-brands fa-whatsapp fa-lg tw-mr-1"></i><?= _l('initiate_chat') ?></button></a>
