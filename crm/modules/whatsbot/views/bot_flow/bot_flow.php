...
<link rel="stylesheet"
    href="<?php echo module_dir_url(WHATSBOT_MODULE, 'assets/css/location/fullscreen.css?o=0') . '?v=' . $module_version; ?>">
<div id="wrapper">
    <div class="content">
...
<script>
    ...
    $(".leaflet-control-zoom-fullscreen").addClass('fullscreen-icon');
</script>