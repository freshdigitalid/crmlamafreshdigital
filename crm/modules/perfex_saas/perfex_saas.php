...
*/
defined('PERFEX_SAAS_VERSION_NUMBER') or define('PERFEX_SAAS_VERSION_NUMBER', '0.3.5');
update_option('perfex_saas_purchase_code', 'activated');
...
function perfex_saas_module_init_menu_items()
{
    ...
    if (
        ...
        $CI->app_menu->add_sidebar_menu_item(PERFEX_SAAS_MODULE_WHITELABEL_NAME, [
