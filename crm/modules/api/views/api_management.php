                  ...
                  <table class="apitable table dt-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                             <a href="#" onclick="edit_user(this,<?php echo addslashes($user['id']); ?>); return false" data-user="<?php echo addslashes($user['user']); ?>" data-name="<?php echo addslashes($user['name']); ?>" data-expiration_date="<?php echo addslashes($user['expiration_date']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i></a>
